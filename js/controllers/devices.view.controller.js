var devicesViewController = angular.module('devices.view.controller', []);

devicesViewController.controller('devicesViewController', ['$scope', '$http', 'restService', function($scope, $http, restService) {
		$scope.loading = false;
		$scope.entries = {};
